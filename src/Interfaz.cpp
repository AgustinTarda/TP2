...
void Interfaz::imprimirViajes(Coordenadas coordenadasDeInicio,Coordenadas coordenadasDeDestino, AdministradorDeRecorridos administradorDeRecorridos, Lista<Viaje> viajes) {
	...
	while (viajes.avanzarCursor()) {
		...
		if (viajeAImprimir.esDirecto()) {
			...
			this -> imprimirMapaDeViajeDirecto(coordenadasDeInicio, coordenadasDeDestino, viajeAImprimir, administradorDeRecorridos);

		} else if (viajeAImprimir.esConCombinacionSimple()) {
			imprimirViajeConCombinacionSimple(viajeAImprimir);

			// Imprime los viajes, descomentar y usar este cuando se termine de probar todo
			this-> imprimirMapaDeViajeCombinacion(coordenadasDeInicio, coordenadasDeDestino, viajeAImprimir, administradorDeRecorridos);
...
void Interfaz::imprimirMapaDeViajeDirecto(Coordenadas coordenadasInicial, Coordenadas coordenadasFinal, Viaje viaje, AdministradorDeRecorridos administradorDeRecorridos){
	DibujadorDeMapa mapa;
...
void Interfaz::imprimirMapaDeViajeCombinacion(Coordenadas coordenadasInicial, Coordenadas coordenadasFinal, Viaje viaje, AdministradorDeRecorridos administradorDeRecorridos){
	DibujadorDeMapa mapa;
